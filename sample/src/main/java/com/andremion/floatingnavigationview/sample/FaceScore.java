...
public class FaceScore extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFloatingNavigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(MenuItem item) {
                ...
                if(item.getTitle().equals("人脸评分")){
                    intent.setClass(FaceScore.this, FaceScore.class);
                }else if (item.getTitle().equals("人脸库添加")){
                    intent.setClass(FaceScore.this, AddPersonActivity.class);
                }else if (item.getTitle().equals("人脸融合")){
                    intent.setClass(FaceScore.this, MainActivity.class);
                }else {
                    intent.setClass(FaceScore.this, MainActivity.class);
                }
        ...
        btn_detect.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                tv_detect_result.setHint("请点击人脸评分");
                select(v);
            }
        });
    ...
    public void uploadSearch(View view) {
        progressDialog = ProgressDialog.show(FaceScore.this, "正在评分...", "");
        ...
        new Thread() {
            ...
            public void run() {
                ...
                String uploadUrl = "http://114.55.24.126:80/detect";
                //上传文件域的请求体部分
                ...
                call.enqueue(new Callback() {
                    ...
                    public void onFailure(Call call, IOException e) {
                        ...
                        Toast toast = Toast.makeText(FaceScore.this, "上传图片失败......", Toast.LENGTH_SHORT);
                    ...
                    public void onResponse(Call call, Response response) throws IOException {
                        ...
                        try{
                            ...
                            Toast toast = Toast.makeText(FaceScore.this, beauty, Toast.LENGTH_SHORT);
                            progressDialog.dismiss();
                            ...
                            // 水印的区域
//                            mPaint.getTextBounds(0, 0, watermarkText.length(), textBounds);
                            // 水印的颜色
