        ...
        mFloatingNavigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(MenuItem item) {
                ...
                if(item.getTitle().equals("人脸评分")){
                    intent.setClass(AddPersonActivity.this, FaceScore.class);
    ...
    public void uploadSearch(View view) {
        ...
        new Thread() {
            ...
            public void run() {
                ...
                String uploadUrl = "114.55.24.126:80/add";
                ...
                call.enqueue(new Callback() {
                    ...
                    public void onFailure(Call call, IOException e) {
                        ...
                        Toast toast = Toast.makeText(AddPersonActivity.this, "添加图片失败......", Toast.LENGTH_SHORT);
